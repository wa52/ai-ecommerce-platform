...
| 售后 | 退款、退货、换货、售后进度 | 申请、审核、退款结果可追踪 | 未实现 |
| 履约 | 物流信息、运单追踪 | 发货、物流公司、轨迹、确认收货 | 未实现 |
...
| 客户 | 客户列表、客户详情、分群 | 订单、消费、标签和权限隔离 | 未实现 |
| 营销 | 优惠券、促销、满减、活动 | 规则配置、使用限制、效果统计 | 未实现 |
| 售后 | 售后单、退款审核、原因统计 | 审核、退款、状态和审计记录 | 未实现 |
| 物流 | 配送模板、发货、物流商 | 运单号、发货通知、轨迹同步 | 未实现 |
